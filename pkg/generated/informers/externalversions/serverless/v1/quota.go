...
import (
	...
	versioned "github.com/SUMMERLm/serverless/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/SUMMERLm/serverless/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/SUMMERLm/serverless/pkg/generated/listers/serverless/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ServerlessV1().Quotas(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServerlessV1().Quotas(namespace).Watch(context.TODO(), options)
			},
		},
		&serverlessv1.Quota{},
		resyncPeriod,
...
func (f *quotaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&serverlessv1.Quota{}, f.defaultInformer)
}

func (f *quotaInformer) Lister() v1.QuotaLister {
	return v1.NewQuotaLister(f.Informer().GetIndexer())
}
