...
// +kubebuilder:printcolumn:name="Elder",type="string",JSONPath=".metadata.labels['quota\\.\\cluster\\.pml\\.com\\.cn/foundingMember']"
// +kubebuilder:printcolumn:name="GQuota",type="string",JSONPath=".metadata.labels['quota\\.\\cluster\\.pml\\.com\\.cn/globalQuota']"
// +kubebuilder:printcolumn:name="LQuota",type="string",JSONPath=".metadata.labels['quota\\.\\cluster\\.pml\\.com\\.cn/quota']"
// +kubebuilder:printcolumn:name="QReq",type="string",JSONPath=".metadata.labels['quota\\.\\cluster\\.pml\\.com\\.cn/quotaRequire']"
// +kubebuilder:printcolumn:name="QRem",type="string",JSONPath=".metadata.labels['quota\\.\\cluster\\.pml\\.com\\.cn/quotaRemain']"
// +kubebuilder:printcolumn:name="QUsed",type="string",JSONPath=".metadata.labels['quota\\.\\cluster\\.pml\\.com\\.cn/quotaUsed']"
// +kubebuilder:printcolumn:name="QStep",type="string",JSONPath=".metadata.labels['quota\\.\\cluster\\.pml\\.com\\.cn/quotaStep']"
// +kubebuilder:printcolumn:name="Stype",type="string",JSONPath=".metadata.labels['quota\\.\\cluster\\.pml\\.com\\.cn/type']"
// +kubebuilder:printcolumn:name="SupervisorName",type="string",JSONPath=".spec.supervisorName"
